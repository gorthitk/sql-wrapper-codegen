...
public class SqlWrapperBuilder
{
    ...
    private void _process(final WrapperConfig sqlWrapperConfig, final String relativeDirectoryPath, final Logger logger)
    {
                ...
                StandardCharsets.UTF_8))
        {
            ...
            ps.println("import org.jet.sql.codegen.QueryProcessor;");
            ps.println("import org.jet.sql.codegen.ResultSetRowContainer;");
            ps.println();
            ...
            ps.println("@Generated(value=\"org.jet.sql.codegen.wrapper.SqlWrapperBuilder\",  date = \"" + LocalDateTime.now().toString() + "\")");
